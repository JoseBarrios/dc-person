...
class Person extends Thing {
    ...
    set additionalName(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.additionalName; }
        else if(Thing.isString(value)){ this.model.additionalName = Thing.utils.capitalize(value); }
    }

    get address(){ return this.model.address }
    set address(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.address; }
    ...
    set affiliation(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.affiliation; }
    ...
    set alumniOf(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.alumniOf; }
    ...
    set award(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.award; }
    ...
    set birthDay(value){
         if(Thing.isString(value) || Thing.isEmpty(value)){ this.model.birthDay = value }
    ...
    set birthPlace(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.birthPlace; }
    ...
    set brand(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.brand; }
    ...
    set colleague(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.colleague; }
    ...
    set contactPoint(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.contactPoint; }
    ...
    set deathDate(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.deathDate; }
    ...
    set deathPlace(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.deathPlace; }
    ...
    set duns(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.duns; }
    ...
    set email(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.email; }
    ...
    set familyName(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.familyName; }
        else if(Thing.isString(value)){
    ...
    set faxNumber(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.faxNumber; }
    ...
    set follows(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.follows; }
    ...
    set founder(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.founder; }
    ...
    set gender(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.gender; }
    ...
    set givenName(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.givenName; }
        else if(Thing.isString(value)){
    ...
    set globalLocationNumber(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.globalLocationNumber; }
    ...
    set hasOfferCatalog(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.hasOfferCatalog; }
    ...
    set hasPOS(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.hasPOS; }
    ...
    set height(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.height; }
    ...
    set homeLocation(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.homeLocation; }
    ...
    set honorificPrefix(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.honorificPrefix; }
    ...
    set honorificSuffix(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.honorificSuffix; }
    ...
    set isicV4(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.isicV4; }
    ...
    set jobTitle(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.jobTitle; }
    ...
    set knows(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.knows; }
    ...
    set makesOffer(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.makesOffer; }
    ...
    set memberOf(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.memberOf; }
    ...
    set naics(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.naics; }
    ...
    set nationality(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.nationality; }
    ...
    set netWorth(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.netWorth; }
    ...
    set owns(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.owns; }
    ...
    set parent(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.parent; }
    ...
    set performerIn(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.performerIn; }
    ...
    set relatedTo(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.relatedTo; }
    ...
    set seeks(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.seeks; }
    ...
    set sibling(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.sibling; }
    ...
    set sponsor(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.sponsor; }
    ...
    set spouse(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.spouse; }
    ...
    set taxID(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.taxID; }
    ...
    set telephone(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.telephone; }
    ...
    set vatID(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.vatID; }
    ...
    set weight(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.weight; }
    ...
    set workLocation(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.workLocation; }
    ...
    set worksFor(value){
        if(Thing.isNull(value) || Thing.isEmpty(value)){ delete this.model.worksFor; }
